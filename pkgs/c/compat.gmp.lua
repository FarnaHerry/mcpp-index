...
#include "../longlong.h"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_and_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_and_n.
   Upstream gets the same effect from mpn/and_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
#define OPERATION_and_n 1
#include "../mpn/generic/logops_n.c"
]],
            ["gmp-6.3.0/mcpp/mcpp_gmp_andn_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_andn_n.
   Upstream gets the same effect from mpn/andn_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mp_clz_tab.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_fib_table.c"] =
[[
/* compat.gmp: generated by upstream's gen-fib, limb=64 nail=0. */
/* This file generated by gen-fib.c - DO NOT EDIT. */
...
__gmp_fib_table[FIB_TABLE_LIMIT+2] = {
  ...
  CNST_LIMB (0xa94fad42221f2702),  /* 93 */
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_hamdist.c"] =
[[
/* compat.gmp: popham.c compiled as mpn_hamdist.
   Upstream gets the same effect from mpn/hamdist.c being a
   symlink to generic/popham.c plus a per-target -D. */
#define OPERATION_hamdist 1
#include "../mpn/generic/popham.c"
]],
            ["gmp-6.3.0/mcpp/mcpp_gmp_ior_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_ior_n.
   Upstream gets the same effect from mpn/ior_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mpn/generic/logops_n.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_iorn_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_iorn_n.
   Upstream gets the same effect from mpn/iorn_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mpn/generic/logops_n.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_mp_bases.c"] =
[[
/* compat.gmp: generated by upstream's gen-bases, limb=64 nail=0. */
...
const struct bases mp_bases[257] =
{
  ...
  /* 256 */ { 8, CNST_LIMB(0x1fffffffffffffff), CNST_LIMB(0xffffffffffffffff), CNST_LIMB(0x8), CNST_LIMB(0x0) },
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_nand_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_nand_n.
   Upstream gets the same effect from mpn/nand_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mpn/generic/logops_n.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_nior_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_nior_n.
   Upstream gets the same effect from mpn/nior_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mpn/generic/logops_n.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_popcount.c"] =
[[
/* compat.gmp: popham.c compiled as mpn_popcount.
   Upstream gets the same effect from mpn/popcount.c being a
   symlink to generic/popham.c plus a per-target -D. */
...
#include "../mpn/generic/popham.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_add_1.c"] =
[[
/* compat.gmp: sec_aors_1.c compiled as mpn_sec_add_1.
   Upstream gets the same effect from mpn/sec_add_1.c being a
   symlink to generic/sec_aors_1.c plus a per-target -D. */
#define OPERATION_sec_add_1 1
#include "../mpn/generic/sec_aors_1.c"
]],
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_div_qr.c"] =
[[
/* compat.gmp: sec_div.c compiled as mpn_sec_div_qr.
   Upstream gets the same effect from mpn/sec_div_qr.c being a
   symlink to generic/sec_div.c plus a per-target -D. */
#define OPERATION_sec_div_qr 1
#include "../mpn/generic/sec_div.c"
]],
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_div_r.c"] =
[[
/* compat.gmp: sec_div.c compiled as mpn_sec_div_r.
   Upstream gets the same effect from mpn/sec_div_r.c being a
   symlink to generic/sec_div.c plus a per-target -D. */
...
#include "../mpn/generic/sec_div.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_pi1_div_qr.c"] =
[[
/* compat.gmp: sec_pi1_div.c compiled as mpn_sec_pi1_div_qr.
   Upstream gets the same effect from mpn/sec_pi1_div_qr.c being a
   symlink to generic/sec_pi1_div.c plus a per-target -D. */
#define OPERATION_sec_pi1_div_qr 1
#include "../mpn/generic/sec_pi1_div.c"
]],
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_pi1_div_r.c"] =
[[
/* compat.gmp: sec_pi1_div.c compiled as mpn_sec_pi1_div_r.
   Upstream gets the same effect from mpn/sec_pi1_div_r.c being a
   symlink to generic/sec_pi1_div.c plus a per-target -D. */
...
#include "../mpn/generic/sec_pi1_div.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_sec_sub_1.c"] =
[[
/* compat.gmp: sec_aors_1.c compiled as mpn_sec_sub_1.
   Upstream gets the same effect from mpn/sec_sub_1.c being a
   symlink to generic/sec_aors_1.c plus a per-target -D. */
...
#include "../mpn/generic/sec_aors_1.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_xnor_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_xnor_n.
   Upstream gets the same effect from mpn/xnor_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include "../mpn/generic/logops_n.c"
            ...
            ["gmp-6.3.0/mcpp/mcpp_gmp_xor_n.c"] =
[[
/* compat.gmp: logops_n.c compiled as mpn_xor_n.
   Upstream gets the same effect from mpn/xor_n.c being a
   symlink to generic/logops_n.c plus a per-target -D. */
...
#include <stdarg.h>
#include <string.h>
#include "../cxx/isfuns.cc"
#include "../cxx/ismpf.cc"
#include "../cxx/ismpq.cc"
#include "../cxx/ismpz.cc"
#include "../cxx/ismpznw.cc"
#include "../cxx/limits.cc"
#include "../cxx/osdoprnti.cc"
#include "../cxx/osfuns.cc"
#include "../cxx/osmpf.cc"
#include "../cxx/osmpq.cc"
#include "../cxx/osmpz.cc"
]],
